...
var ArrayType = (function (_super) {
    ...
    ArrayType.prototype.render = function () {
        var _a = this.props, name = _a.name, data = _a.data;
        var collapsed = this.state.collapsed;
        return (React.createElement("div", { className: "render-json--flex render-json_array" },
            ...
            React.createElement("div", { className: "render-json_data" }, collapsed ?
                React.createElement("div", { className: "clickable", onClick: this.toggleCollapsed },
                    ...
                    React.createElement("span", { className: "render-json_array_count" }, data.length),
