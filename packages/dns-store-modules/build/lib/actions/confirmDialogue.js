...
exports.confirmDialogueActions = {
    closeDialogue: typesafe_actions_1.createAction('CLOSE_CONFIRM_DIALOGUE'),
    openDialogue: typesafe_actions_1.createAction('OPEN_CONFIRM_DIALOGUE', function (resolve) {
        return function (data) { return resolve({ data: data }); };
    }),
};
